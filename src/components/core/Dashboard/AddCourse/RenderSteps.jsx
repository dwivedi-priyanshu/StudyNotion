...
import CourseInformationForm from './CourseInformation/CourseInformation/CourseInformationForm'
...
const RenderSteps = () => {
    ...
    return (
        ...
        <>
            <div className="relative mb-2 flex w-full justify-center">
                {
                    steps.map((item) => (
                        <>
                            ...
                            {/* below is the code for displaying dashed lines */}
            ...
            {/* for displaying content below each step  */}
